...
import static com.cinntra.standalone.activities.AddOrderAct.fromquotation;
...
//        });
        ...
        CategoryAdapter adapter = new CategoryAdapter(AddOrderForm_One_Fragment.this, MainActivity.itemCategoryDataFromLocal,TaxListdialog);
        recyclerview.setLayoutManager(new LinearLayoutManager(getContext(), RecyclerView.VERTICAL,false));
        recyclerview.setAdapter(adapter);
