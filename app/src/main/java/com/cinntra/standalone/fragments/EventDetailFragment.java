...
//                        myTime.set(0,0,0,t1hr,t1min);
    ...
    private void setData(EventValue value) {
        binding.eventContent.titleText.setText(value.getTitle());
        binding.eventContent.fromValue.setText(value.getFrom());
        binding.eventContent.toValue.setText(value.getTo());
        binding.eventContent.timeValue.setText(value.getTime());
        binding.eventContent.addLocationText.setText(value.getLocation());
        binding.eventContent.hostText.setText(value.getHost());
        binding.eventContent.participantValue.setText(value.getParticipants());
        binding.eventContent.descriptionText.setText(value.getDescription());
        binding.eventContent.relatedDocumentValue.setText(value.getRelatedTo());
        ...
        if(newEvent.getPriority().equalsIgnoreCase("high")) {
            binding.eventContent.colorSpinner.setSelection(0);
        }
        else if (newEvent.getPriority().equalsIgnoreCase("medium")) {
            binding.eventContent.colorSpinner.setSelection(1);
        }
        else{
            binding.eventContent.colorSpinner.setSelection(2);
        }
