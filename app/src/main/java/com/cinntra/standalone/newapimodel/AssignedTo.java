...
public class AssignedTo implements Parcelable
{
    ...
    public final static Creator<AssignedTo> CREATOR = new Creator<AssignedTo>() {
        ...
        public com.cinntra.standalone.newapimodel.AssignedTo createFromParcel(android.os.Parcel in) {
            return new com.cinntra.standalone.newapimodel.AssignedTo(in);
        }

        public com.cinntra.standalone.newapimodel.AssignedTo[] newArray(int size) {
            return (new com.cinntra.standalone.newapimodel.AssignedTo[size]);
        }
